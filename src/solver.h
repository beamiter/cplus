...
template <typename T> struct AbstractSolverDeclare {};

#define AbstractSolverDeclare AbstractSolverDeclare<T>

template <typename T> auto statas(AbstractSolverDeclare solver) {
  return solver.stats;
}
...
template <typename T> auto solvername(AbstractSolverDeclare solver) {
